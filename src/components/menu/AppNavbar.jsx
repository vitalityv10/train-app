    ...
    <Navbar bg="white" expand="lg" sticky="top" className="shadow-sm py-3">
      <Container>
        <Navbar.Brand
          as={Link}
          to="/"
          className="text-primary fw-bold fs-4 d-flex align-items-center"
        >
            ...
            {user ? (
              <>
                <Nav.Link
                  as={Link}
                  to="/wish-list"
                  className={getLinkClass("/wish-list")}
                  title="Wish List"
                >
                  <FaHeart className="d-lg-none" />{" "}
                  <span className="d-lg-none">Wish List</span>
                ...
                <Nav.Link
                  ...
                  title="Cart"
                >
                  <FaShoppingCart className="d-lg-none" />{" "}
